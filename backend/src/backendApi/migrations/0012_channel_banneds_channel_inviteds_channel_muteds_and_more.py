...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('backendApi', '0011_bannedcommand_bannedreason_mutedcommand_mutedreason_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='until',
            field=models.DateTimeField(default=datetime.datetime(2024, 2, 14, 17, 7, 34, 63572, tzinfo=datetime.timezone.utc)),
        ),
    ]
