...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('backendApi', '0022_user_friends_alter_channel_banneds_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='until',
            field=models.DateTimeField(default=datetime.datetime(2024, 2, 14, 18, 19, 54, 833914, tzinfo=datetime.timezone.utc)),
        ),
        migrations.AlterField(
            model_name='user',
            name='friends',
